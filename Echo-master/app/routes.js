...
import { fetchDataForHomePage, getPlaylistOnEnter } from "./route_callbacks";
import { fetchOnScroll } from "./HOC";

export default (
  <Route path="/" component={Containers.App}>
    <IndexRoute
      component={fetchOnScroll(Containers.HomePage)}
      onEnter={fetchDataForHomePage}
    />
